...
FROM ubuntu:${UBUNTU_VERSION} AS rc
...
RUN git clone -b rc https://github.com/instill-ai/api-gateway.git api-gateway
RUN git clone -b rc https://github.com/instill-ai/pipeline-backend.git pipeline-backend
RUN git clone -b rc https://github.com/instill-ai/connector-backend.git connector-backend
RUN git clone -b rc https://github.com/instill-ai/model-backend.git model-backend
RUN git clone -b rc https://github.com/instill-ai/mgmt-backend.git mgmt-backend
RUN git clone -b rc https://github.com/instill-ai/console.git console
