...
export default function () {
    group("Trigger: Semantic Segmentation model", function () {
        ...
        verify.verifySemanticSegmentation(`${model}`, "url", modelTags, http.request("POST", `${constant.apiHost}/v1alpha/pipelines/${model}/trigger`, JSON.stringify({
            "task_inputs": [{
        ...
        verify.verifySemanticSegmentation(`${model}`, "base64", modelTags, http.request("POST", `${constant.apiHost}/v1alpha/pipelines/${model}/trigger`, JSON.stringify({
            "task_inputs": [{
                "semantic_segmentation": {
        ...
        verify.verifySemanticSegmentation(`${model}`, "form_data", modelTags, http.request("POST", `${constant.apiHost}/v1alpha/pipelines/${model}/trigger-multipart`, fd.body(), {
            headers: {
